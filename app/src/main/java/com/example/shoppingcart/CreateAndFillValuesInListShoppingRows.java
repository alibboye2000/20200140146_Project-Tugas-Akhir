...
public class CreateAndFillValuesInListShoppingRows extends BaseExpandableListAdapter {
    ...
    private ArrayList<ExpandshoppingGroup> groups;

    public CreateAndFillValuesInListShoppingRows(Context context, ArrayList<ExpandshoppingGroup> groups) {
    ...
    public View getGroupView(int groupPosition, boolean isLastChild, View view, ViewGroup parent) {
        ...
        ExpandshoppingGroup group=(ExpandshoppingGroup)getGroup(groupPosition);
        if (view==null)
        {
        ...
        View viewId=view.findViewById(R.id.deleteRow); // This when click the icon on the app it shows list of items so we have to create menu.
        if (viewId!=null)
        {
    ...
    // Here i inflate expand shopping item
    @Override
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View view, ViewGroup parent) {
        ...
        {
            LayoutInflater inf=(LayoutInflater) context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
            view=inf.inflate(R.layout.expandlist_shopping_item,null);
        }
    ...
    public void addItem(ShopItem item,ExpandshoppingGroup group)
    {
